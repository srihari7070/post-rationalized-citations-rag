...
papers themselves; and every thesis figure — is here. The thesis document itself is
submitted separately and is not distributed in this repository.
...
| `reference_papers/` | Full text of 44 of the 49 cited papers — all open-access arXiv preprints |
...
Full methodology, including the reasoning behind every design choice, is in Chapter 3 of
the thesis itself, which is submitted separately and is not distributed in this
repository.
...
`reference_papers/` contains the full text of 44 of the 49 works cited in the thesis, all
...
that file predates some later additions to the bibliography). The remaining 5 — Cohen
(1960), Landis & Koch (1977), Cohen (1988), Wilcoxon (1945), and Malin et al. (2025) —
are paywalled journal articles, a JSTOR-hosted scan, a book, and an IEEE-published
review, none with a legitimate open-access copy; they're cited by reference only, in
